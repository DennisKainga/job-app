                ...
                <div class="col-lg-8  col-md-8 col-sm-12 post-list blog-post-list">
                    <div class="single-post">
                        ...
                        <div class="custom-container">
                            ...
                            in America by making it illegal to transfer money to them through any US bank
                            or payment system. As a result of this law, most of the popular online casino
                            networks such as Party Gaming and PlayTech left the United States.
                            Overnight, online casino players found themselves being chased by the Federal government.banking”
                        </div>
                        <p>
                            MCSE boot camps have its supporters and its detractors. Some
                    ...
                    <!--nav area-->
                    <div class="container nav-area pt-50 pb-100">
                        <div class="row justify-content-between">
                            <div class="col-sm-6 nav-left align-items-start d-flex">
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('assets/img/blog/prev.jpg') }}" alt="" />
                                </div>
                            ...
                            <div class="col-sm-6 nav-right justify-content-end d-flex">
                                ...
                                <div class="thumb">
                                    <img class="img-fluid" src="{{ asset('assets/img/blog/next.jpg') }}" alt="" />
                                </div>
                            ...
                            <div class="row flex-column">
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img class="img-fluid" src="{{ asset('assets/img/blog/c1.jpg') }}" alt="" />
                                            </div>
                                            <div class="desc">
                                                <h5>
                                                    <a href="#">Emily Blunt</a>
                                                </h5>
                                                <p class="date">December 4, 2017 at 3:12pm</p>
                                                <p class="comment">
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img class="img-fluid" src="{{ asset('assets/img/blog/c2.jpg') }}" alt="" />
                                            </div>
                                            <div class="desc">
                                                <h5>
                                                    <a href="#">Emily Blunt</a>
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img class="img-fluid" src="{{ asset('assets/img/blog/c3.jpg') }}" alt="" />
                                            </div>
                                            <div class="desc">
                                                <h5>
                                                    <a href="#">Emily Blunt</a>
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img class="img-fluid" src="{{ asset('assets/img/blog/c4.jpg') }}" alt="" />
                                            </div>
                                            <div class="desc">
                                                <h5>
                                                    <a href="#">Emily Blunt</a>
                                ...
                                <div class="comment-list">
                                    <div class="single-comment justify-content-between d-flex">
                                        <div class="user justify-content-between d-flex">
                                            <div class="thumb">
                                                <img class="img-fluid" src="{{ asset('assets/img/blog/c5.jpg') }}" alt="" />
                                            </div>
                                            <div class="desc">
                                                <h5>
                                                    <a href="#">Emily Blunt</a>
                            ...
                            <div class="row flex-row d-flex">
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <input name="email" placeholder="Enter your email" onfocus="this.placeholder =''"
                                        onblur="this.placeholder='Enter your email' " class="common-input mb-20 form-control" required
                                        type="email">
